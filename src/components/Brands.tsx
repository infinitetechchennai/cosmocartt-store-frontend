    ...
    <section className="pt-6 pb-6 sm:pt-8 sm:pb-8 bg-gradient-to-b from-white via-[#faf7ff] to-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-8">
          ...
          <Link
            to="/brands"
            className="hidden md:inline-flex items-center gap-2 px-6 py-3 rounded-full bg-slate-900 text-white font-bold hover:bg-[#4B1E78] transition"
          >
            View All Brands
            <ArrowRight size={18} />
          </Link>
        ...
        <div className="mt-7 flex justify-center md:hidden">
          <Link
            to="/brands"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-slate-900 text-white font-bold hover:bg-[#4B1E78] transition"
          >
            View All Brands
            <ArrowRight size={18} />
          </Link>
